...
def main() -> int:
    ...
    payload["milestone"] = "MTM-013-stable"
    payload["version"] = "0.4.0"
    payload["purpose"] = "Stable 0.4.0 A5 non-regression only; not a performance claim."
    payload["wrapper_harness_sha256"] = sha256_file(Path(__file__))
